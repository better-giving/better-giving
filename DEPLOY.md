...
A Chariot grant is never refunded here: once the fund has paid, Chariot reports no refund. A gift recorded by hand has no processor to report one, so its refund is a correction in `/admin/books`.
