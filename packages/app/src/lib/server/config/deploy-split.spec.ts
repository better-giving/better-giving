...
//
// every one of the twenty-four is a plain var, and `packages/operator/src/deploy-split.ts` argues
 ...
 * the twenty-four names after it, which the pattern above does catch.
 */
