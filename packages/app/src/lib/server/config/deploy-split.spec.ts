...
//
// every one of the thirteen is a plain var, and `packages/operator/src/deploy-split.ts` argues why.
 ...
 * the thirteen names after it, which the pattern above does catch.
 */
