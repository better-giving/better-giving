...
// groups and ./lib/secret-groups.spec.ts holds the covering that files every one of the thirteen in
...
/* the groups nobody types, which are the ones a page is allowed to draw no block for.
   ...
   because lib/secret-groups.spec.ts's covering has to file every one of the thirteen somewhere.
