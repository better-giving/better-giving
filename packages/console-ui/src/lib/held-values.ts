...
//
// **each of the twenty-one is a plain var, so the account hands its value back** (`DEPLOY_VARS` in
...
// under one of the twenty-one that is not plain text — a deployment that stored the value as a
 ...
 * box to be typed out of whether or not it would have had one, and two of the twenty-one are minted
