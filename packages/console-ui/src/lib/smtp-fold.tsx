...
// that answers for all twenty-one and no box is drawn at all where that read did not land.
//
...
export type SmtpFoldProps = {
	/** the twenty-one as cloudflare answered for them, which is what the five boxes are seeded from. */
...
export function SmtpFold({
	...
	/**
	 * what this deployment holds under each of the twenty-one, or `null` where that read did not land.
	 *
