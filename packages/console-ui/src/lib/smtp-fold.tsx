...
// that answers for every one of them and no box is drawn at all where that read did not land.
//
...
export type SmtpFoldProps = {
	/**
	 * the deploy-time values as cloudflare answered for them, which is what the five boxes are seeded
	 * from.
	 */
