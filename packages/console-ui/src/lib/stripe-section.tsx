...
//
// **the two names every read is scoped to and the deploy-time values arrive as props.** what this
...
export type StripeSectionProps = {
	/**
	 * the deploy-time values as cloudflare answered for them, which is what every reading here is
	 * drawn from.
	 */
					...
					>
						...
						<div className="adm-stack">
							<Field
								...
								code
								// which names arrive masked, the publishable key below among the ones
