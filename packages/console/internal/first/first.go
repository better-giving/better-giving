...
//
// Eight of them are the deploy engine's own, reported through as they arrive rather than summarised:
...
// not the engine's eight in a row. the order this file heads with is why.
var Stages = []Stage{
